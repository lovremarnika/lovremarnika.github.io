...
window.MJESTA_TISKANJA = {
  ...
  "Rim":       { koord: [41.8931, 12.4828], drzava: "Italija",    biljeska: "Prva talijanska tiskara (Sweynheym i Pannartz). Ondje 1474. izlazi govor Nikole Modruškog." },
  "Verona":    { koord: [45.4384, 10.9916], drzava: "Italija",    biljeska: "Dobrić Dobrićević ovdje tiska prije preseljenja u Bresciu." },
  "Firenza":   { koord: [43.7696, 11.2558], drzava: "Italija",    biljeska: "Središte humanističkoga nakladništva; ondje izlaze djela Jurja Dragišića." },
  "Senj":      { koord: [44.9894, 14.9040], drzava: "Hrvatska",   biljeska: "Prva tiskara na hrvatskom tlu. Od 1494. ondje se tiskaju glagoljska izdanja." },
  ...
  "Cremona":   { koord: [45.1332, 10.0227], drzava: "Italija",    biljeska: "Lombardijska tiskara; ovdje se kao priređivač javlja i Dobrić Dobrićević." },
  "Lyon":      { koord: [45.7640,  4.8357], drzava: "Francuska",  biljeska: "Najveće francusko tiskarsko središte uz Pariz." },
  "Nürnberg":  { koord: [49.4521, 11.0767], drzava: "Njemačka",   biljeska: "Njemačko trgovačko i tiskarsko čvorište." },
  "Augsburg":  { koord: [48.3705, 10.8978], drzava: "Njemačka",   biljeska: "Ovdje djeluje Erhard Ratdolt nakon venecijanskoga razdoblja." },
